...
namespace Online_SHopping_Cart.Controllers
    {
        public class SellerController : Controller
        {
            ...
            public void Notification_Count()
            {
                ...
                ViewBag.ordering = orderlist.DistinctBy(x => x.Orderid);
                Session["notif-count"] = orderlist.DistinctBy(x => x.Orderid).Count();
            }
            ...
            public ActionResult Notification()
            {
                ...
                ViewBag.orderlist = list.DistinctBy(x => x.OrderId);
                return View();
            }
